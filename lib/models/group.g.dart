...
extension GroupQueryLinks on QueryBuilder<Group, Group, QFilterCondition> {
  QueryBuilder<Group, Group, QAfterFilterCondition> thoughts(
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> thoughtsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> thoughtsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'thoughts', 0, true, 0, true);
    });
  }

  QueryBuilder<Group, Group, QAfterFilterCondition> thoughtsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'thoughts', 0, false, 999999, true);
    });
  }

  QueryBuilder<Group, Group, QAfterFilterCondition> thoughtsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> thoughtsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> thoughtsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
